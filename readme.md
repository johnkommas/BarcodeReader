...
> Α. Μεγάλο Μέγεθος, σε αυτό το μέγεθος εκτυπώνονται 8 ταμπελάκια σε κάθε σελίδα και το χαρτί δεν χωράει στην ετικετοθέση του ραφιού <br>
> Β. Μικρό Μέγεθος, σε αυτό το μέγεθος εκτυπώνονται 14 ταμπελάκια σε κάθε σελίδα και το χαρτί χψράει ακριβώς στην ετικετοθέση του ραφιού
